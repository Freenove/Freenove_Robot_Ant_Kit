...
void Emotion_Show(void);                                //Display:0-Display off,1-Turn the eyes,2-cry eyes,3-smile,4-right-wheel,5-left-wheel,6-blink
void Emotion_SetMode(int mode, int static_emotion = 0); //Set the emotion show mode
